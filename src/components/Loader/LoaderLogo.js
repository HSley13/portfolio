...
class LogoLoader extends React.Component {
  render() {
    ...
    return (
      ...
      .letter{
        opacity: 0;
        -webkit-animation: fadein 1.5s linear forwards 2.4s;
        -o-animation: fadein 1.5s linear forwards 2.4s;
        -moz-animation: fadein 1.5s linear forwards 2.4s;
        animation: fadein 1.5s linear forwards 2.4s;
      }
